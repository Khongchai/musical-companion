...
import useTotalPagesMemoized from "../../../utils-hooks/useTotalPagesMemoized";
...
const AccompanimentCards: React.FC<{
  ...
  const { totalPagesMemoized = 1 } = useTotalPagesMemoized(allProductsData);
